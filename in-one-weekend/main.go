...
func main() {
	...
	world.Add(maths.NewSphere(maths.NewVec3(1.0, 0, -1.0), 0.5, maths.NewMetal(maths.NewVec3(0.8, 0.6, 0.2), 1.0)))
	world.Add(maths.NewSphere(maths.NewVec3(-1.0, 0, -1.0), 0.5, maths.NewMetal(maths.NewVec3(0.8, 0.8, 0.8), 0.3)))
